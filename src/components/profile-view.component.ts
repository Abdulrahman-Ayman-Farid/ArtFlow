    ...
    <div class="max-w-2xl mx-auto p-6">
      <div class="bg-slate-800 rounded-2xl p-8 shadow-xl border border-slate-700">
        <div class="flex items-center justify-between mb-8">
          ...
          <button (click)="onClose.emit()" class="text-slate-400 hover:text-white transition-colors">
        ...
        <form [formGroup]="profileForm" (ngSubmit)="onSubmit()" class="space-y-8">
          ...
          <div class="flex flex-col items-center sm:flex-row gap-8">
            <div class="relative group">
              <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-500/30 shadow-lg">
